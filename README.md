...
![](https://github.com/user-attachments/assets/a279369d-9ec7-4f92-9cd9-4f4982ed00ab)
...
> **Prerequisites**
> - FFmpeg - Download [FFmpeg binaries](https://ffmpeg.org/) and place `FFmpeg.exe` and `FFprobe.exe` in `C:\Windows\`   
